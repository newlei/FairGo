...
print(run_id)
dataset='lastfm'
path_save_base='./fm0log/'+dataset+'/filter_lineargcn'+run_id
...
copyfile('./graph_gcn_gender.py', path_save_base+'/graph_gcn_gender'+run_id+'.py')
...
path_save_model_base='../fm0Model/'+dataset+'/filter_lineargcn'+run_id
...
users_emb_gcn = np.load(saved_model_path+'/gcnModel/lastfm/lineargcnfmg18/user_emb_epoch50.npy',allow_pickle=True)    
items_emb_gcn = np.load(saved_model_path+'/gcnModel/lastfm/lineargcnfmg18/item_emb_epoch50.npy',allow_pickle=True)    
